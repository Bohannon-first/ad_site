...
// Коллекция всех объявлений поступивших с сервера
let arrayAds = null;
setTimeout(() => {
  arrayAds = listResults.querySelectorAll('.results__item.product');
}, 100);

// Получаем доступные объявления
const getAvailableAds = (adObject) => {
  // console.log(adObject.products);
...
export {getAvailableAds, listResults, arrayAds};
